...
describe('EventDetailPage Integration - Parent Event Display', () => {
  ...
  it('renders event with parent displayed in combobox', async () => {
    ...
    expect(parentCombobox?.textContent).toContain('Parent Event - Annual Review');
  ...
  it('verifies parent event ID is correctly stringified from ObjectId', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByDisplayValue('Department Meeting')).toBeInTheDocument();
    });
  ...
  it('renders deeply nested parent hierarchy correctly', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByDisplayValue('Led Migration Project')).toBeInTheDocument();
    });
  ...
  it('renders complete HTML structure with all event fields and parent', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByDisplayValue('Dissertation Defense')).toBeInTheDocument();
    });

    expect(screen.getByDisplayValue('Dissertation Defense')).toBeInTheDocument();
    expect(screen.getByDisplayValue('Defense')).toBeInTheDocument();
    expect(screen.getByDisplayValue('Final defense presentation')).toBeInTheDocument();
